...
const ASSETS = ['./', './index.html', './style.css', './app.js',
                './viz.css', './charts.js', './piano.js', './prodotti.js', './foto.js', './camera.js', './palestra.js',
                './hyrox.js', './sfide.js', './giorno.js', './anim.js', './icone.js', './timer.js', './seduta.js', './carico.js', './cardio.js', './peso.js', './cerca.js', './spesa.js', './salute.js', './scambio.js', './copie.js', './pdf.js', './statistiche.js', './confronto.js', './ai.js', './assistente.js', './revisione.js', './previsioni.js', './obiettivo.js', './leve.js', './target.js', './data/fisici.json', './data/sfide.json', './data/palestra.json', './data/corpo.json', './data/hyrox.json',
