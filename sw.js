...
const ASSETS = ['./', './index.html', './style.css', './app.js',
                ...
                './hyrox.js', './sfide.js', './giorno.js', './anim.js', './timer.js', './carico.js', './cardio.js', './peso.js', './cerca.js', './salute.js', './scambio.js', './pdf.js', './statistiche.js', './confronto.js', './revisione.js', './previsioni.js', './target.js', './data/sfide.json', './data/palestra.json', './data/corpo.json', './data/hyrox.json',
